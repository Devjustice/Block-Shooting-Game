...
#include<GL/glut.h>
#include<string.h>
int maxy = 600, count = 0, maxx = 500, r, q;
float n=0.5,m=0.5;
int count1 = 0, count2 = 0, count3 = 0, count4 = 0, count5 = 0, count6 =
	0, count7 = 0, count8 = 0, count9 = 0, count10 = 0;
float x = 25, y = 50;
char str[10];
void id1();
void id();
...
void counting()
{
	...
	if (count1 == 1 && count2 == 1 && count3 == 1 && count4 == 1 && count5 == 1
		...
		&& count10 == 1)
	{
		bitmap_output(5, 300, "CONGRATULATIONS YOU WON",
...
int main(int argc, char **argv)
{
	...
	glutAddMenuEntry
		("You loose the game if the arrow count exceeds the blocks count", 7);
